...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo URL; ?>egames/img/core-img/LOGOX.png">

    <!-- Stylesheet -->
    <link rel="stylesheet" href="<?php echo URL; ?>egames/style.css">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 d-flex align-items-center justify-content-between">
                        <!-- Logo Area -->
                        <div class="logo">
                            <a href="index.html">CYBER GAMES X</a>
                        </div>
                        ...
                        <div class="search-login-area d-flex align-items-center">
                            ...
                            <div class="login-area">
                              <div id="login"></div>
                                <a href="<?php echo URL; ?>home/index"><span>Login / Register</span> <i class="fa fa-lock" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="game-review.html">Productos</a>
                                        <ul class="dropdown">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="100ms">
                        <img src="<?php echo URL; ?>egames/img/bg-img/game1.jpg" alt="">
                        <a href="#" class="btn egames-btn mt-30">Productos PlayStation 4</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="300ms">
                        <img src="<?php echo URL; ?>egames/img/bg-img/images.png" alt="">
                        <a href="#" class="btn egames-btn mt-30">Productos Nintendo</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <img src="<?php echo URL; ?>egames/img/bg-img/game3.jpg" alt="">
                        <a href="#" class="btn egames-btn mt-30">Productos XBox</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="tab-pane fade show active" id="popular" role="tabpanel" aria-labelledby="popular-tab">
                ...
                <div class="popular-games-slideshow owl-carousel">
                    ...
                    <div class="single-games-slide">
                        <img src="<?php echo URL; ?>egames/img/bg-img/50.jpg" alt="">
                    ...
                    <!-- Single Games -->
                    <div class="single-games-slide">
                        <img src="<?php echo URL; ?>egames/img/bg-img/51.jpg" alt="">
                        <div class="slide-text">
                    ...
                    <!-- Single Games -->
                    <div class="single-games-slide">
                        <img src="<?php echo URL; ?>egames/img/bg-img/52.jpg" alt="">
                        <div class="slide-text">
                    ...
                    <!-- Single Games -->
                    <div class="single-games-slide">
                        <img src="<?php echo URL; ?>egames/img/bg-img/53.jpg" alt="">
                        <div class="slide-text">
                    ...
                    <!-- Single Games -->
                    <div class="single-games-slide">
                        <img src="<?php echo URL; ?>egames/img/bg-img/54.jpg" alt="">
                        <div class="slide-text">
                        ...
                        <div class="nav flex-column" id="video-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active" id="video1" data-toggle="pill" href="#video-1" role="tab" aria-controls="video-1" aria-selected="true">
                                ...
                                <div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="100ms">
                                    <div class="video-thumbnail">
                                        <img src="<?php echo URL; ?>egames/img/bg-img/14.jpg" alt="">
                                    </div>
                            ...
                            <a class="nav-link" id="video2" data-toggle="pill" href="#video-2" role="tab" aria-controls="video-2" aria-selected="false">
                                ...
                                <div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="200ms">
                                    <div class="video-thumbnail">
                                        <img src="<?php echo URL; ?>egames/<?php echo URL; ?>egames/img/bg-img/15.jpg" alt="">
                                    </div>
                                    <div class="video-text">
                            ...
                            <a class="nav-link" id="video3" data-toggle="pill" href="#video-3" role="tab" aria-controls="video-3" aria-selected="false">
                                ...
                                <div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="300ms">
                                    <div class="video-thumbnail">
                                        <img src="<?php echo URL; ?>egames/img/bg-img/16.jpg" alt="">
                                    </div>
                                    <div class="video-text">
                            ...
                            <a class="nav-link" id="video4" data-toggle="pill" href="#video-4" role="tab" aria-controls="video-4" aria-selected="false">
                                ...
                                <div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="400ms">
                                    <div class="video-thumbnail">
                                        <img src="<?php echo URL; ?>egames/img/bg-img/17.jpg" alt="">
                                    </div>
                                    <div class="video-text">
                                        <p class="video-title mb-0">Assemble Your Squad and Join the Battle</p>
                                        <span>Nintendo Wii, PS4, XBox 360</span>
                            ...
                            <a class="nav-link" id="video5" data-toggle="pill" href="#video-5" role="tab" aria-controls="video-5" aria-selected="false">
                                ...
                                <div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="500ms">
                                    <div class="video-thumbnail">
                                        <img src="<?php echo URL; ?>egames/img/bg-img/18.jpg" alt="">
                                    </div>
                                    <div class="video-text">
                                        <p class="video-title mb-0">Tips to improve your game</p>
                                        <span>Nintendo Wii, PS4, XBox 360</span>
                            ...
                            <a class="nav-link" id="video7" data-toggle="pill" href="#video-7" role="tab" aria-controls="video-7" aria-selected="false">
                                ...
                                <div class="single-video-widget d-flex wow fadeInUp" data-wow-delay="700ms">
                                    <div class="video-thumbnail">
                                        <img src="<?php echo URL; ?>egames/img/bg-img/15.jpg" alt="">
                                    </div>
                                    <div class="video-text">
                                        <p class="video-title mb-0">Tips to improve your game</p>
                                        <span>Nintendo Wii, PS4, XBox 360</span>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="mb-100">
                        ...
                        <div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="300ms">
                            <div class="article-thumbnail">
                                <img src="<?php echo URL; ?>egames/img/bg-img/6.jpg" alt="">
                            </div>
                        ...
                        <div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                            <div class="article-thumbnail">
                                <img src="<?php echo URL; ?>egames/img/bg-img/7.jpg" alt="">
                            </div>
                            <div class="article-content">
                        ...
                        <div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="700ms">
                            <div class="article-thumbnail">
                                <img src="<?php echo URL; ?>egames/img/bg-img/8.jpg" alt="">
                            </div>
                            <div class="article-content">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="single-widget-area add-widget wow fadeInUp" data-wow-delay="300ms">
                        <a href="#"><img src="<?php echo URL; ?>egames/img/bg-img/add.png" alt=""></a>
                        <!-- Side Img -->
                        <img src="<?php echo URL; ?>egames/img/bg-img/side-img.png" class="side-img" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- jQuery-2.2.4 js -->
    <script src="<?php echo URL; ?>egames/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="<?php echo URL; ?>egames/js/bootstrap/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="<?php echo URL; ?>egames/js/bootstrap/bootstrap.min.js"></script>
    <!-- All Plugins js -->
    <script src="<?php echo URL; ?>egames/js/plugins/plugins.js"></script>
    <!-- Active js -->
    <script src="<?php echo URL; ?>egames/js/active.js"></script>
</body>
